...
class Menu:
    ...
    def get(self):
        ...
        ****** TCP/UDP Network ******
        ...
        """
        # your code here
        menu_list = json.dumps(menu)
        # print(menu)
        return menu_list

    @staticmethod
    def option(option_choice):
        """
        ...
        """
        option = json.loads(option_choice)
        # if option > 13 | option < 1 & type(option) != int:  #if number does not exist return menu again
        #     return 0
        return option

    @staticmethod
    def request_headers(option_choice,request):
        """
        ...
        """
        if option_choice == 0:
            headers = request['headers']['username']
        else:
            headers = ""
        return headers
